...
/*********************************** Fixups ***********************************/
...
#ifdef YAFFS2
    #include <yaffsfs.h>
    #define file_open yaffs_open
    #define file_write yaffs_write
    #define file_read yaffs_read
    #define file_close yaffs_close
    #define file_stat yaffs_stat
    #define file_lseek yaffs_lseek
    #define file_unlink yaffs_unlink
#endif
    ...
    typedef long fd_mask;
    struct sockaddr_storage { char pad[1024]; };
    #define gethostname(s, l) strcpy(s, "0.0.0.0")
    #define chdir(x) (1)
