 ...
 */
#if YAFFS2
typedef struct yaffs_stat WebsStat;
#else
...
/**
    ...
    @ingroup WebsSocket
 */
PUBLIC_DATA WebsSocket **socketList;         /* List of open sockets */
...
/**
    ...
    @ingroup WebsSocket
 */
PUBLIC int socketGetError(void);
...
/**
    ...
    @internal
 */
PUBLIC WebsTime websRunEvents(void);
...
/**
    ...
    @ingroup Webs
 */
PUBLIC WebsTime websCgiPoll(void);
...
/**
    ...
    @ingroup Webs
 */
PUBLIC char *websGetServer(void);
...
/**
    ...
    @ingroup Webs
 */
PUBLIC char *websGetServerUrl(void);
...
/**
    ...
    @ingroup Webs
 */
PUBLIC char *websGetServerAddress(void);
...
/**
    ...
    @ingroup Webs
 */
PUBLIC char *websGetServerAddressUrl(void);
