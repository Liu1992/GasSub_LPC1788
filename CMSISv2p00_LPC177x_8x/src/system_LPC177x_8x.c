 ...
 *----------------------------------------------------------------------------*/
uint32_t SystemCoreClock __attribute__ ((section("STARTUP_DATA"))) = __CORE_CLK;/*!< System Clock Frequency (Core Clock)*/
uint32_t PeripheralClock __attribute__ ((section("STARTUP_DATA"))) = __PER_CLK; /*!< Peripheral Clock Frequency (Pclk)  */
uint32_t EMCClock		 __attribute__ ((section("STARTUP_DATA"))) = __EMC_CLK; /*!< EMC Clock Frequency 				  */
uint32_t USBClock 		 __attribute__ ((section("STARTUP_DATA"))) = (48000000UL);		  /*!< USB Clock Frequency - this value will
