...
/* Define default fonts */
  ...
  #define LISTVIEW_FONT_DEFAULT &GUI_FontHZ16
#endif
...
/*********************************************************************
*
*   My Add : Enter Information val
*
**********************************************************************/

static unsigned char EnterPressed = 0;
...
static int _AddKey(LISTVIEW_Handle hObj, int Key) {
  ...
  case GUI_KEY_UP:
    ...
    return 1;               /* Key has been consumed */
	case GUI_KEY_ENTER:       /* My Add: react of key_enter  */
		WM_LOCK();
		EnterPressed = GUI_KEY_ENTER;
		WM_UNLOCK();
		return 1;
	case GUI_KEY_TAB:       /* My Add: react of key_enter  */
		WM_LOCK();
		EnterPressed = GUI_KEY_TAB;
		WM_UNLOCK();
		return 1;
  }
