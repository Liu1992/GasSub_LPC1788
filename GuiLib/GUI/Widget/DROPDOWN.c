...
/* Define default fonts */
  ...
  #define DROPDOWN_FONT_DEFAULT &GUI_FontHZ16
#endif
...
static void _DROPDOWN_Callback (WM_MESSAGE*pMsg) {
  ...
  case WM_NOTIFY_PARENT:
	//	DROPDOWN_SetSel(hObj, pMsg->Data.v);
    switch (pMsg->Data.v) {
		case WM_NOTIFICATION_SEL_CHANGED://此处增加
    ...
    case WM_NOTIFICATION_CLICKED:
      ...
      WM_SetFocus(hObj);
      break;
    case LISTBOX_NOTIFICATION_LOST_FOCUS://此处增加
			DROPDOWN_SetSel(hObj, LISTBOX_GetSel(pObj->hListWin));
